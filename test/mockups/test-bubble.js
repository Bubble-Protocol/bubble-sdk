...
import { BubblePermissions, ContentId, Bubble, bubbleProviders, ecdsa } from '../../packages/client';
...
owner.key = new ecdsa.Key(owner.privateKey);
...
requester.key = new ecdsa.Key(requester.privateKey);
