...
describe("Guardian/Provider Integration Tests", () => {
  ...
  describe("RPC succeeds", () => {
    ...
    test("read file with a plain signature and eip712 delegate generated by MetaMask", async () => {
      //
      // Delegate generated with the following code in the browser
      //
      // const ethersProvider = new ethers.BrowserProvider(provider);
      // const signer = await ethersProvider.getSigner();
      // const signFn = eip712.getEIP712SignFunction('delegate', signer.signTypedData.bind(signer));
      // const delegate = new Delegation("0x6d0AAEfC704694cC50c0d9A5693294bcb585eC49", 2147483647);
      // delegate.permitAccessToBubble({
      //   chain: 137, 
      //   contract: "0x0000000000000000000000000000000000000001", 
      //   provider: 'bubble.io'
      // })
      // await delegate.sign(signFn);
